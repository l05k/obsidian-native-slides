...
4. **Review and merge**: a maintainer reviews and merges human contributions — please don't merge your own PRs. Agent-driven work follows the mandatory review loop in [AGENTS.md](AGENTS.md) (Rule 2): one independent review by a Herdr subagent, after which the authoring agent may squash-merge its own PR once CI is green. Either way, don't rebase `main` into your branch unless asked.
