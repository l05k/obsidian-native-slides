...
var NativeSlidesPlugin = class extends import_obsidian7.Plugin {
  ...
  refresh() {
    ...
    if (this.settings.showNavButtons && deck) {
      ...
      nav.appendChild(
        navButton("\u25C0", "Previous page", () => void this.navigate("prev"), !hasPrev)
      );
      nav.appendChild(
        navButton("\u25B6", "Next page", () => void this.navigate("next"), !hasNext)
      );
