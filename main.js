...
var NativeSlidesPlugin = class extends import_obsidian7.Plugin {
  ...
  scheduleSoloCertify() {
    ...
    const tick = () => {
      this.soloImageFrame = null;
      if (window.performance.now() >= this.soloRetagUntil) return;
