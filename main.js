...
var NativeSlidesPlugin = class extends import_obsidian7.Plugin {
  ...
  refresh() {
    ...
    const mdView = slides ? this.app.workspace.getActiveViewOfType(import_obsidian7.MarkdownView) : null;
