...
var ConfirmDeleteModal = class extends import_obsidian4.Modal {
  ...
  onOpen() {
    ...
    const label = this.names.length === 1 ? "Delete this slide?" : `Delete ${this.names.length} slides?`;
    ...
    new import_obsidian4.Setting(this.contentEl).setName("Don't ask again").addToggle(
      (toggle) => toggle.setValue(false).onChange(async () => {
        await this.onDontAsk();
        toggle.setDisabled(true);
      })
    );
    new import_obsidian4.Setting(this.contentEl).addButton((btn) => btn.setButtonText("Cancel").onClick(() => this.close())).addButton(
